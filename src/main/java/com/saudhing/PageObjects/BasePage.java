...
public class BasePage {
	...
	public void clickElement(WebElement element, String elementName) {
		try {
			...
			ExtentTestManager.logInfo("Clicked on element: "+ elementName);
		} catch (Exception e) {
			System.out.println("Unable to wait and click on WebElement, Exception: " + e.getMessage());
			ExtentTestManager.logFail("Unable to click on the WebElement: "+ elementName + ". Exception: "+ e.getMessage());
			//Assert.fail("Unable to click on the WebElement: " + elementName);
		}
	}

	public void clickElementsUsingByLocator(By by, String elementName) throws InterruptedException {
		try {
			...
			ExtentTestManager.logFail("Clicked on element: "+ elementName);
	...
	public void clickOnElementUsingCustomTimeout(WebElement locator, int timeout) {
		try {
